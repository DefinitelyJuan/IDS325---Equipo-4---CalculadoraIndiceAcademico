<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEditarAsignaturaDocente.aspx.cs" Inherits="CalculadoraIndiceAcademico.frmEditarAsignaturaDocente" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css" integrity="sha512-KfkfwYDsLkIlwQp6LFnl8zNdLGxu9YAA1QvwINks4PhcElQSvqcyVLLD9aMhXd13uQjoXtEKNosOWaZqXgel0g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <title>Editar Asignatura Docente</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container py-0 px-0">
            ...
            <div class="d-flex align-items-center flex-column p-3">
                <h4 class="mainHeading">EDITAR ASIGNATURA DOCENTE</h4>
