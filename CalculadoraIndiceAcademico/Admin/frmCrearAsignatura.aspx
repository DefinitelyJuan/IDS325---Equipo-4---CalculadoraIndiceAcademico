<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCrearAsignatura.aspx.cs" Inherits="CalculadoraIndiceAcademico.frmCrearAsignatura" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container py-0 px-0">
            ...
            <div class="d-flex align-items-center flex-column p-3">
                ...
                <asp:ObjectDataSource ID="dsAreas" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CalculadoraIndiceAcademico.dsSCIATableAdapters.tblAreasAcademicasTableAdapter" UpdateMethod="Update">
                    <DeleteParameters>
