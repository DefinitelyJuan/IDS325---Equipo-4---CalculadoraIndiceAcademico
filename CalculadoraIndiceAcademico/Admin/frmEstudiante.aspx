<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEstudiante.aspx.cs" Inherits="CalculadoraIndiceAcademico.frmEstudiante" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container py-0 px-0">
            ...
            <div class="d-flex align-items-center flex-column p-3">
                ...
                <asp:TextBox ID="txtNumeroTelefono" runat="server" CssClass="txt" MaxLength="10" TextBoxMode="Phone" TextMode="Number"></asp:TextBox>
