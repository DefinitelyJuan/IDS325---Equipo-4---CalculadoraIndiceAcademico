<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmEditarAsignatura.aspx.cs" Inherits="CalculadoraIndiceAcademico.frmEditarAsignatura" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container py-0 px-0">
            ...
            <div class="d-flex align-items-center flex-column p-3">
                <h4 class="mainHeading">EDITAR ASIGNATURA</h4>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CalculadoraIndiceAcademico.dsSCIATableAdapters.tblAreasAcademicasTableAdapter" UpdateMethod="Update">
                    <DeleteParameters>
            ...
            <div class="d-flex justify-content-center">
                <asp:Button ID="btnGuardar" runat="server" Text="Guardar" CssClass="btnGuardar" OnClick="btnGuardar_Click" OnClientClick="return confirm('¿Está seguro de que quiere actualizar el registro?');" />
            </div>
